...
var get_countries = require('../views/internationalmvp-v2/scripts/countries.js');
...
router.get('/secure', function(req, res) {
  res.render('internationalmvp-v2/secure');
});
...
router.get('/what-countries-have-you-lived-in', function(req, res) {
  res.render('internationalmvp-v2/what-countries-have-you-lived-in');
});
...
router.get('/relationship-status', function(req, res) {
    res.render('internationalmvp-v2/relationship-status');
})
...
router.all('/relationship-status-date/:type', function(req, res) {
  if (req.body.submit === "Continue") {
    res.redirect("/internationalmvp-v2/relationship-status-more/"+req.params.type);
  }else{
    var isMarried = false,
        isEnded = false;
    ...
    res.render('internationalmvp-v2/relationship-status-date', {
      eventText: eventText,
...
router.all('/relationship-status-more/:type', function(req, res) {
  if (req.body.submit === "Continue") {
    res.redirect("/internationalmvp-v2/contact");
  }else{
    var isMarried = false,
        isEnded = false,
        widowed = false;
    ...
    res.render('internationalmvp-v2/relationship-status-more',{type: req.params.type,pageHeader: pageHeader,isEnded: isEnded, isMarried: isMarried, widowed: widowed });
  }
});

// Contact page
router.get('/contact', function(req, res) {
  res.render('internationalmvp-v2/contact');
});
...
router.get('/bank-details', function(req, res) {
  res.render('internationalmvp-v2/bank-details');
});
...
router.get('/unhappy-ending', function(req, res) {
  req.session.view = null;
  res.render('internationalmvp-v2/unhappy-ending');
});

router.get('/end', function(req, res) {
  var completeDate = get_todays_date();

  res.render('internationalmvp-v2/end', {completeDate: completeDate});
});
...
router.get('/settings', function(req, res) {
  res.render('internationalmvp-v2/settings');
});
