...
router.get('/secure', function (req, res) {
      ...
      if(fields.indexOf(6) > -1){ ob.value6 = true; text["field"+Object.keys(text).length] = "6th"; }
...
router.post('/secure', function (req, res) {
      ...
      if(req.body.value8 !== undefined){ fields.push(6); ob.value6 = true; text["field"+Object.keys(text).length] = "6th"; }
...
router.all('/relationship-status', function (req, res) {
  if(req.body.relationship === "Never been married"){
        ...
        res.redirect("relationship-status-info/"+req.body.relationship);
  }
...
router.all('/relationship-status-info/:type', function (req, res) {
